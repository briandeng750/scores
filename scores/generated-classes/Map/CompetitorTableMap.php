...
class CompetitorTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.CompetitorTableMap';
     ...
     */
    const TABLE_NAME = 'competitor';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Competitor';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Competitor';
     ...
     */
    const COL_ID = 'competitor.ID';

    /**
     * the column name for the category field
     */
    const COL_CATEGORY = 'competitor.category';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'competitor.name';

    /**
     * the column name for the number field
     */
    const COL_NUMBER = 'competitor.number';

    /**
     * the column name for the team field
     */
    const COL_TEAM = 'competitor.team';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Category', 'Name', 'Number', 'Team', ),
        self::TYPE_CAMELNAME     => array('id', 'category', 'name', 'number', 'team', ),
        self::TYPE_COLNAME       => array(CompetitorTableMap::COL_ID, CompetitorTableMap::COL_CATEGORY, CompetitorTableMap::COL_NAME, CompetitorTableMap::COL_NUMBER, CompetitorTableMap::COL_TEAM, ),
        self::TYPE_FIELDNAME     => array('ID', 'category', 'name', 'number', 'team', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Category' => 1, 'Name' => 2, 'Number' => 3, 'Team' => 4, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'category' => 1, 'name' => 2, 'number' => 3, 'team' => 4, ),
        self::TYPE_COLNAME       => array(CompetitorTableMap::COL_ID => 0, CompetitorTableMap::COL_CATEGORY => 1, CompetitorTableMap::COL_NAME => 2, CompetitorTableMap::COL_NUMBER => 3, CompetitorTableMap::COL_TEAM => 4, ),
        self::TYPE_FIELDNAME     => array('ID' => 0, 'category' => 1, 'name' => 2, 'number' => 3, 'team' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('team', 'Team', 'VARCHAR', false, 255, null);
    } // initialize()
    ...
    {
        $this->addRelation('CompetitorCompetitorresults', '\\CompetitorCompetitorresults', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':competitor_ID',
    1 => ':ID',
  ),
), null, null, 'CompetitorCompetitorresultss', false);
  ...
  array (
...
), 'CASCADE', null, 'MeetCompetitors', false);
    } // buildRelations()
    /**
     * Method to invalidate the instance pool of all tables related to competitor     * by a foreign key with ON DELETE CASCADE
     */
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(CompetitorTableMap::COL_CATEGORY);
            $criteria->addSelectColumn(CompetitorTableMap::COL_NAME);
            $criteria->addSelectColumn(CompetitorTableMap::COL_NUMBER);
            $criteria->addSelectColumn(CompetitorTableMap::COL_TEAM);
        } else {
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(CompetitorTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(CompetitorTableMap::TABLE_NAME)) {
            $dbMap->addTableObject(new CompetitorTableMap());
        }
    }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Competitor) { // it's a model object
...
//
CompetitorTableMap::buildTableMap();
