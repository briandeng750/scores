...
/**
 * This class defines the structure of the 'ezs_users' table.
 *
 *
 *
...
class UsersTableMap extends TableMap
{
    ...
    /**
     * the column name for the ezs_user_id field
     */
    const COL_EZS_USER_ID = 'ezs_users.ezs_user_id';

    /**
     * the column name for the ezs_username field
     */
    const COL_EZS_USERNAME = 'ezs_users.ezs_username';

    /**
     * the column name for the ezs_password field
     */
    const COL_EZS_PASSWORD = 'ezs_users.ezs_password';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(UsersTableMap::COL_EZS_USER_ID, UsersTableMap::COL_EZS_USERNAME, UsersTableMap::COL_EZS_PASSWORD, ),
        self::TYPE_FIELDNAME     => array('ezs_user_id', 'ezs_username', 'ezs_password', ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(UsersTableMap::COL_EZS_USER_ID => 0, UsersTableMap::COL_EZS_USERNAME => 1, UsersTableMap::COL_EZS_PASSWORD => 2, ),
        self::TYPE_FIELDNAME     => array('ezs_user_id' => 0, 'ezs_username' => 1, 'ezs_password' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        // columns
        $this->addPrimaryKey('ezs_user_id', 'Id', 'INTEGER', true, null, null);
        $this->addColumn('ezs_username', 'Username', 'VARCHAR', false, 20, null);
        $this->addColumn('ezs_password', 'Password', 'VARCHAR', false, 40, null);
    } // initialize()
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(UsersTableMap::COL_EZS_USER_ID);
            $criteria->addSelectColumn(UsersTableMap::COL_EZS_USERNAME);
            $criteria->addSelectColumn(UsersTableMap::COL_EZS_PASSWORD);
        } else {
            $criteria->addSelectColumn($alias . '.ezs_user_id');
            $criteria->addSelectColumn($alias . '.ezs_username');
            $criteria->addSelectColumn($alias . '.ezs_password');
        }
    }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(UsersTableMap::COL_EZS_USER_ID, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(UsersTableMap::COL_EZS_USER_ID) && $criteria->keyContainsValue(UsersTableMap::COL_EZS_USER_ID) ) {
