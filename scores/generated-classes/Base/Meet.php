...
/**
 * Base class that represents a row from the 'meet' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class Meet implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\MeetTableMap';
    ...
    /**
     * Initializes internal state of Base\Meet object.
     */
    ...
    /**
     * Compares this with another <code>Meet</code> instance.  If
     * <code>obj</code> is an instance of <code>Meet</code>, delegates to
     * <code>equals(Meet)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Meet The current object, for fluid interface
     */
     ...
     * @return $this|\Meet The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[MeetTableMap::COL_ID] = true;
        }
    ...
    public function setDate($v)
    {
        ...
        if ($this->date !== null || $dt !== null) {
            if ($this->date === null || $dt === null || $dt->format("Y-m-d") !== $this->date->format("Y-m-d")) {
                ...
                $this->modifiedColumns[MeetTableMap::COL_DATE] = true;
            }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[MeetTableMap::COL_DESCRIPTION] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : MeetTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : MeetTableMap::translateFieldName('Date', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : MeetTableMap::translateFieldName('Description', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = MeetTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Meet'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildMeetQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildMeetQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                MeetTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(MeetTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'ID';
        }
        if ($this->isColumnModified(MeetTableMap::COL_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'date';
        }
        if ($this->isColumnModified(MeetTableMap::COL_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = 'description';
        }

        $sql = sprintf(
            'INSERT INTO meet (%s) VALUES (%s)',
    ...
    {
        $pos = MeetTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Meet'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Meet'][$this->hashCode()] = true;
        $keys = MeetTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getDate(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(MeetTableMap::COL_ID)) {
            $criteria->add(MeetTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(MeetTableMap::COL_DATE)) {
            $criteria->add(MeetTableMap::COL_DATE, $this->date);
        }
        if ($this->isColumnModified(MeetTableMap::COL_DESCRIPTION)) {
            $criteria->add(MeetTableMap::COL_DESCRIPTION, $this->description);
        }
    ...
    {
        $criteria = ChildMeetQuery::create();
        $criteria->add(MeetTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Meet (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Meet Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildMeet is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildMeet The current object (for fluent API support)
     */
    public function setMeetCompetitors(Collection $meetCompetitors, ConnectionInterface $con = null)
    {
        ...
        foreach ($meetCompetitorsToDelete as $meetCompetitorRemoved) {
            $meetCompetitorRemoved->setMeet(null);
        }
     ...
     * Otherwise if this Meet is new, it will return
     * an empty collection; or if this Meet has previously
     * been saved, it will retrieve related MeetCompetitors from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Meet.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildMeetCompetitor[] List of ChildMeetCompetitor objects
     */
    public function getMeetCompetitorsJoinCompetitor(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildMeetCompetitorQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(MeetTableMap::DEFAULT_STRING_FORMAT);
    }
