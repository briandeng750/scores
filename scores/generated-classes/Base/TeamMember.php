...
/**
 * Base class that represents a row from the 'TEAM_MEMBER' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class TeamMember implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\TeamMemberTableMap';
    ...
    /**
     * @var        ObjectCollection|ChildTeam[] Cross Collection to store aggregation of ChildTeam objects.
     */
    protected $collTeams;
    ...
    /**
     * Initializes internal state of Base\TeamMember object.
     */
    ...
    /**
     * Compares this with another <code>TeamMember</code> instance.  If
     * <code>obj</code> is an instance of <code>TeamMember</code>, delegates to
     * <code>equals(TeamMember)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|TeamMember The current object, for fluid interface
     */
     ...
     * @return $this|\TeamMember The current object (for fluent API support)
     */
    public function setNumber($v)
    {
        ...
        if ($this->number !== $v) {
            $this->number = $v;
            $this->modifiedColumns[TeamMemberTableMap::COL_NUMBER] = true;
        }
    ...
    public function setCategory($v)
    {
        ...
        if ($this->category !== $v) {
            $this->category = $v;
            $this->modifiedColumns[TeamMemberTableMap::COL_CATEGORY] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[TeamMemberTableMap::COL_NAME] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : TeamMemberTableMap::translateFieldName('Number', TableMap::TYPE_PHPNAME, $indexType)];
            $this->number = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : TeamMemberTableMap::translateFieldName('Category', TableMap::TYPE_PHPNAME, $indexType)];
            $this->category = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : TeamMemberTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = TeamMemberTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\TeamMember'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildTeamMemberQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see TeamMember::setDeleted()
     * @see TeamMember::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildTeamMemberQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                TeamMemberTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(TeamMemberTableMap::COL_NUMBER)) {
            $modifiedColumns[':p' . $index++]  = 'number';
        }
        if ($this->isColumnModified(TeamMemberTableMap::COL_CATEGORY)) {
            $modifiedColumns[':p' . $index++]  = 'category';
        }
        if ($this->isColumnModified(TeamMemberTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }

        $sql = sprintf(
            'INSERT INTO TEAM_MEMBER (%s) VALUES (%s)',
    ...
    {
        $pos = TeamMemberTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['TeamMember'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['TeamMember'][$this->hashCode()] = true;
        $keys = TeamMemberTableMap::getFieldNames($keyType);
        $result = array(
    ...
    {
        $criteria = new Criteria(TeamMemberTableMap::DATABASE_NAME);

        if ($this->isColumnModified(TeamMemberTableMap::COL_NUMBER)) {
            $criteria->add(TeamMemberTableMap::COL_NUMBER, $this->number);
        }
        if ($this->isColumnModified(TeamMemberTableMap::COL_CATEGORY)) {
            $criteria->add(TeamMemberTableMap::COL_CATEGORY, $this->category);
        }
        if ($this->isColumnModified(TeamMemberTableMap::COL_NAME)) {
            $criteria->add(TeamMemberTableMap::COL_NAME, $this->name);
        }
    ...
    {
        $criteria = ChildTeamMemberQuery::create();
        $criteria->add(TeamMemberTableMap::COL_NUMBER, $this->number);
     ...
     * If this ChildTeamMember is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildTeamMember The current object (for fluent API support)
     */
    public function setTeamTeamMembers(Collection $teamTeamMembers, ConnectionInterface $con = null)
    {
        ...
        foreach ($teamTeamMembersToDelete as $teamTeamMemberRemoved) {
            $teamTeamMemberRemoved->setTeamMember(null);
        }
    ...
    protected function doAddTeamTeamMember(ChildTeamTeamMember $teamTeamMember)
    {
        ...
        $teamTeamMember->setTeamMember($this);
    }
    ...
    public function removeTeamTeamMember(ChildTeamTeamMember $teamTeamMember)
    {
        if ($this->getTeamTeamMembers()->contains($teamTeamMember)) {
            ...
            $teamTeamMember->setTeamMember(null);
        }
     ...
     * @return ObjectCollection|ChildTeamTeamMember[] List of ChildTeamTeamMember objects
     */
    public function getTeamTeamMembersJoinTeam(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildTeamTeamMemberQuery::create(null, $criteria);
     ...
     * @return bool
     */
    public function isTeamsLoaded()
    {
        return null !== $this->collTeams;
    }
    ...
    /**
     * Associate a ChildTeam to this object
     * through the TEAM_TEAM_MEMBER cross reference table.
     *
     * @param ChildTeam $team
     * @return ChildTeamMember The current object (for fluent API support)
     */
    public function addTeam(ChildTeam $team)
    {
    ...
    protected function doAddTeam(ChildTeam $team)
    {
        ...
        if (!$team->isTeamMembersLoaded()) {
            $team->initTeamMembers();
            $team->getTeamMembers()->push($this);
        } elseif (!$team->getTeamMembers()->contains($this)) {
            $team->getTeamMembers()->push($this);
        }
    ...
    {
        if ($this->getTeams()->contains($team)) { $teamTeamMember = new ChildTeamTeamMember();

            $teamTeamMember->setTeam($team);
            if ($team->isTeamMembersLoaded()) {
                //remove the back reference if available
                $team->getTeamMembers()->removeObject($this);
            }
    ...
    {
        return (string) $this->exportTo(TeamMemberTableMap::DEFAULT_STRING_FORMAT);
    }
